...
public final class SavedCars extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.adapter = new MyAdapter(var10004);
        ...
        pullToRefresh.setOnRefreshListener((SwipeRefreshLayout.OnRefreshListener)(new SwipeRefreshLayout.OnRefreshListener() {
            public final void onRefresh() {
                SavedCars.this.getElements().clear();
                SavedCars.this.loadDataFromDatabase();
                MyAdapter var10000 = SavedCars.this.adapter;
                if (var10000 != null) {
            ...
            case 1000327:
                ...
                alertDialog.setTitle((CharSequence)"Enter Car Manufacturer's Name and click go ").setMessage((CharSequence)"To view your saved cars, click on View Saved Cars. \nFor More help click More").setPositiveButton((CharSequence)"More", (DialogInterface.OnClickListener)(new DialogInterface.OnClickListener() {
                    public final void onClick(DialogInterface $noName_0, int $noName_1) {
                        Intent intent = new Intent((Context)SavedCars.this, MenuItems.class);
                        intent.putExtra("help", true);
                        SavedCars.this.startActivity(intent);
                    }
    ...
    protected void onResume() {
        ...
        this.element.clear();
        this.loadDataFromDatabase();
        MyAdapter var10000 = this.adapter;
        if (var10000 != null) {
            var10000.notifyDataSetChanged();
        }
    ...
    public static final void access$setTabl$p(SavedCars $this, Boolean var1) {
        $this.isTabl = var1;
    }

    public static final void access$setAdapter$p(SavedCars $this, MyAdapter var1) {
        $this.adapter = var1;
    }
    ...
    public final class MyAdapter extends BaseAdapter {
        ...
        public int getCount() {
            return SavedCars.this.getElements().size();
        }
        ...
        public View getView(final int position, @Nullable View convertView, @Nullable ViewGroup parent) {
            ...
            if (view != null) {
                view.setOnClickListener((View.OnClickListener)(new View.OnClickListener() {
                    public final void onClick(View it) {
                        ...
                        Cars var10002 = (Cars)SavedCars.this.getElements().get(position);
                        dataToPass.putString("MakeID", var10002 != null ? var10002.returnMakeID() : null);
                        var10002 = (Cars)SavedCars.this.getElements().get(position);
                        ...
                        if (isTabl == true) {
                            SavedCars.this.dFrag = new CarOptions();
                            SavedCars.this.dFrag.setArguments(dataToPass);
                            SavedCars.this.getSupportFragmentManager().beginTransaction().replace(R.id.frame, (Fragment)SavedCars.this.dFrag).commit();
                        } else {
                            Intent phoneIntent = new Intent(it.getContext(), EmptyActivity.class);
                            phoneIntent.putExtras(dataToPass);
                            SavedCars.this.startActivity(phoneIntent);
                        }
            ...
            Cars var10001 = (Cars)SavedCars.this.getElements().get(position);
            make.setText((CharSequence)(var10001 != null ? var10001.returnMake() : null));
            var10001 = (Cars)SavedCars.this.getElements().get(position);
