...
public class CarsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isTabl = frame != null;
        carsQuery s = new carsQuery((Context)this);
            ...
            case R.id.help:
                ...
                alertDialog.setTitle((CharSequence)"Enter Car Manufacturer's Name and click go ").setMessage((CharSequence)"To view your saved cars, click on View Saved Cars. \nFor More help click More").setPositiveButton((CharSequence)"More", (DialogInterface.OnClickListener)(new DialogInterface.OnClickListener() {
                    public final void onClick(DialogInterface $noName_0, int $noName_1) {
                        Intent intent = new Intent((Context)CarsList.this, MenuItems.class);
    ...
    public final class carsQuery extends AsyncTask <String, Integer, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
               ...
               HttpURLConnection modelConnection = (HttpURLConnection) new URL(new URL(strings[0]), CarsList.this.getIntent().getStringExtra("search")).openConnection();
        ...
        protected void onPostExecute(@Nullable String result) {
            ...
            Toast.makeText(CarsList.this.getApplicationContext(), element.size() + "results found", Toast.LENGTH_LONG).show();

            CarsList var10002 = CarsList.this;
            Context var10003 = list.getContext();
            MyAdapter adapter = var10002.new MyAdapter(var10003);
                ...
                if (view != null) {
                    view.setOnClickListener((View.OnClickListener)(new View.OnClickListener() {
                        public final void onClick(View it) {
                            ...
                            if (isTabl) {
                                CarsList.this.dFrag = new CarOptions();
                                CarsList.this.dFrag.setArguments(dataToPass);
                                CarsList.this.getSupportFragmentManager().beginTransaction().replace(R.id.frame, dFrag).commit();
                            } else {
                                Intent phoneIntent = new Intent(it.getContext(), EmptyActivity.class);
                                phoneIntent.putExtras(dataToPass);
                                CarsList.this.startActivity(phoneIntent);
                            }
