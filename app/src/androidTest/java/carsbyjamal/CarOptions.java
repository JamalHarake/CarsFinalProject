...
import com.cst2335.teamproject.R;
...
public final class CarOptions extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final DataBase db = new DataBase(var10002);
        ...
        viewD.setOnClickListener((View.OnClickListener)(new View.OnClickListener() {
            public final void onClick(View it) {
                ...
                CarOptions.this.startActivity(browserIntent);
            }
        }));
        ...
        if (isSaved) {
            ...
            saveB.setOnClickListener((View.OnClickListener)(new View.OnClickListener() {
                public final void onClick(View it) {
                    CarOptions var10000 = CarOptions.this;
    ...
    private final ArrayList getModels(Context context) {
        ...
        String[] columns = new String[]{DataBase.getCars.getCOL_MODELID()};
        Cursor var10000 = db.getWritableDatabase().query(false, DataBase.getCars.getTABLENAME(), columns, (String)null, (String[])null, (String)null, (String)null, (String)null, (String)null);
        Cursor results = var10000;
        int modelIndex = results.getColumnIndex(DataBase.getCars.getCOL_MODELID());
    ...
    public static final void access$setParentActivity$p(CarOptions $this, AppCompatActivity var1) {
