...
final class DataBase extends SQLiteOpenHelper {
    ...
    public static final class getCars {
        ...
        public final String getDATABASENAME() {
            return com.cst2335.teamproject.DataBase.DATABASENAME;
        }

        public final int getVERSION_NUM() {
            return com.cst2335.teamproject.DataBase.VERSION_NUM;
        }

        @NotNull
        public static final String getTABLENAME() {
            return com.cst2335.teamproject.DataBase.TABLENAME;
        }

        @NotNull
        public final String getCOL_ID() {
            return com.cst2335.teamproject.DataBase.COL_ID;
        }

        @NotNull
        public static final String getCOL_MODELID() {
            return com.cst2335.teamproject.DataBase.COL_MODELID;
        }

        @NotNull
        public static final String getCOL_MODEL() {
            return com.cst2335.teamproject.DataBase.COL_MODEL;
        }

        @NotNull
        public static final String getCOL_MAKEID() {
            return com.cst2335.teamproject.DataBase.COL_MAKEID;
        }

        @NotNull
        public static final String getCOL_MAKE() {
            return com.cst2335.teamproject.DataBase.COL_MAKE;
        }
